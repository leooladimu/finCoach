...
export default function GoalsPage() {
  ...
  const handleUpdateProgressSubmit = async (e: React.FormEvent) => {
    ...
    // Save to KV
    if (userId) {
      const goalToUpdate = updatedGoals.find(
              ...
              <div className="glass rounded-xl border border-violet-500/30 p-4">
                ...
                <p className="text-2xl font-bold text-violet-500">
                  {(
                    goals.reduce(
                      (sum, goal) =>
                        sum + (goal.currentAmount / goal.targetAmount) * 100,
                      0,
                    ) / goals.length
                  ).toFixed(1)}
                  %
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    {!moneyStyle ? (
                      <>
                        ...
                        <p className="text-neutral-400 mb-6 max-w-md mx-auto">
                          Take our 3-minute Money Style assessment to unlock
                          personalized goal recommendations and coaching.
                        </p>
                        <Link
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-blue-500/10 rounded-xl border border-blue-500/30">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400 mt-1">
                      At your current pace, you&apos;ll reach your goal 2 months
                      early!
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-orange-500/10 rounded-xl border border-orange-500/30">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400 mt-1">
                      Consider increasing your monthly contribution to stay on
                      track.
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="glass rounded-2xl border border-emerald-500/30 p-6 relative">
              ...
              {moneyStyle ? (
                <>
                  <p className="text-2xl font-bold mb-3 text-emerald-500">
                    {moneyStyle.type}
                  </p>
                ...
                <div className="py-4">
                  ...
                  <p className="text-sm text-neutral-400 leading-relaxed mb-4">
                    Discover your personalized Money Style to unlock tailored
          ...
          <div className="glass rounded-2xl border border-white/20 p-8 max-w-md w-full">
            <div>
              ...
              <p className="text-neutral-400 mb-6 leading-relaxed">
                Connect your financial institutions to automatically track your
                progress and spending patterns.
              </p>
