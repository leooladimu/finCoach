  ...
  const actionItems = [
    {
      ...
      description:
        "You&apos;re currently 27% over budget in entertainment. Start by identifying subscriptions you rarely use.",
      steps: [
    ...
    },
    {
      ...
      description:
        "Automate your house down payment savings to ensure consistent progress toward your goal.",
      steps: [
    ...
    },
    {
      ...
      description:
        "Dining out increased 40% this month. Meal prep can help reduce food costs while maintaining quality.",
      steps: [
    ...
    },
    {
      ...
      description:
        "Insurance costs can often be reduced by bundling or shopping around for better rates.",
      steps: [
    ...
    },
    {
      ...
      description:
        "Ensure your investment portfolio aligns with your timeline for buying a house.",
      steps: [
    ...
    },
    {
      ...
      description:
        "Strengthen your financial foundation before making major purchases.",
      steps: [
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-neutral-400">
            Concrete steps to close the gap between your current behavior and
            financial goals.
          </p>
        </div>
        ...
        <div className="mb-8 glass rounded-2xl border border-white/10 p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              <p className="text-sm font-serif text-stone-600 mb-1">
                Total Actions
              </p>
            ...
            {quickWins.map((win, index) => (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-neutral-400">
                    <span className="font-semibold text-white">Effort:</span>{" "}
                    {win.effort}
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2 flex-wrap">
                        <h3
                          className={`font-bold text-white text-lg ${isCompleted ? "line-through" : ""}`}
                        >
                          {item.title}
                        </h3>
                        <span
                          className={`text-xs font-semibold px-2 py-1 rounded-full bg-gradient-to-r ${priorityColors[item.priority as "high" | "medium" | "low"]} text-white`}
                        >
                          {item.priority}
                        </span>
                      ...
                      <p className="text-stone-800 font-serif mb-3">
                        {item.description}
                      </p>
                      ...
                      {!isCompleted && (
                        <>
                          <div className="bg-stone-50/60 rounded-lg p-4 border border-stone-300/50 mb-3">
                            <p className="text-sm font-serif font-semibold text-stone-900 mb-2">
                              Steps to complete:
                            </p>
                            <ul className="space-y-1">
                              {item.steps.map((step, index) => (
                                <li
                                  key={index}
                                  className="text-sm font-serif text-stone-800 flex items-start gap-2"
                                >
          ...
          <div className="bg-gradient-to-br from-amber-50 to-stone-50 rounded-lg border-4 border-double border-amber-800/40 p-6 shadow-xl relative overflow-hidden">
            ...
            <p className="text-stone-800 font-serif">
              {moneyStyle.type.includes("J") ? (
                <>
                  As a Judger, you thrive on structure and completion. Use the
                  checkboxes above to track your progress — checking off tasks
                  will give you satisfaction and momentum.
                </>
              ) : (
                <>
                  As a Perceiver, rigid plans can feel constraining. Treat these
                  actions as flexible guidelines rather than strict
                  requirements. Start with what feels most energizing.
                </>
              )}{" "}
              {moneyStyle.type.includes("S") ? (
                <>
                  Your Sensing preference means you value practical, concrete
                  steps. Each action includes specific tasks you can complete
                  today.
                </>
              ) : (
                <>
                  Your Intuitive preference means you see the big picture. Focus
                  on how each action connects to your long-term vision for
